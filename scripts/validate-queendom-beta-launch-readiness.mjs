...
assert(/app\.js\?v=0\.10\.(?:81\.3|8[2-9]|\d{3,})/.test(clientHtml) && /styles\.css\?v=0\.10\.(?:81\.3|8[2-9]|\d{3,})/.test(clientHtml), 'Client cache keys regressed below the beta-launch baseline.');
