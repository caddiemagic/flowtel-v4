...
for(const token of ['priestess-mailbox-card','priestessMailboxSection','page.js?v=0.10.80.6']) assert(mailboxHtml.includes(token),`Dedicated mailbox HTML is missing ${token}.`);
