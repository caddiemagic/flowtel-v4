...
assert(managerHtml.includes('styles.css?v=0.10.80.2') && managerHtml.includes('app.js?v=0.10.80.2'), "Concierge cache keys are not on the current Flowtel release.");
