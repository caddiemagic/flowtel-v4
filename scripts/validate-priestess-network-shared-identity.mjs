...
assert(managerHtml.includes('styles.css?v=0.10.80.1') && managerHtml.includes('app.js?v=0.10.80.1'), "Concierge cache keys are not on the current Flowtel release.");
...
assert(flowtelJs.includes('profiles.js?v=0.10.75') && flowtelJs.includes('priestess-profiles.js?v=0.10.75'), "Flowtel barrel exports can serve stale profile modules.");
