...
assert(managerHtml.includes('styles.css?v=0.10.80.4') && managerHtml.includes('app.js?v=0.10.80.4'), "Concierge cache keys are not on the current Flowtel release.");
