...
for(const token of ["meetingAction(call,label='Join Zoom')",'wm-enter-womb-magic','noopener noreferrer','Zoom room will appear here']) assert(files['shared/womb-magic-booking.js'].includes(token));
